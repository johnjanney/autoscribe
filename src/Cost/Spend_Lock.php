 ...
 * @since 1.0.2
 */
final class Spend_Lock extends Named_Lock {

	/**
	 * Builds the lock over the spend scope.
	 *
	 * The mechanism moved to Named_Lock in 1.11.0, when arming a prompt and
	 * opening a run turned out to need the same thing for the same reason. This
	 * remains its own class because the callers of the spend check should not have
	 * to know the name of the lock they are taking.
	 *
	 * @since 1.0.2
	 */
