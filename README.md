...
Version 1.0.3. Two external audits have been run against this plugin, and both
found real defects; the findings, the fixes, and the two findings rejected with
evidence are in `CODEX-REVIEW.md` and `CODEX-REVIEW-RESPONSE.md`. 216 tests run
