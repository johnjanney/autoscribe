...
Version 1.18.0. Thirteen external audits have been run against this plugin, and
all thirteen found real defects; the findings, the fixes, and the findings rejected
with evidence are in `CODEX-REVIEW.md` and `CODEX-REVIEW-RESPONSE.md`. 487 tests
